...
<div class="row justify-content-center">
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/27.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="Jakarta Metro Lines" %}
  </div>
</div>
...
<div class="row justify-content-center">
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/28.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="View of the city's CBD from National Monument square" %}
  </div>
</div>
...
<div class="row justify-content-center">
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/29.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="The Church of Our Lady of the Assumption" %}
  </div>
</div>
...
<div class="row justify-content-center">
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/30.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="Motorcycles and cars running side by side" %}
  </div>
</div>
...
<div class="row justify-content-center">
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/31.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="The Surabaya city at sunrise blue hour" %}
  </div>
</div>
...
<div class="row justify-content-center">
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/32.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="Volcanoes in a Sea of ​​Clouds" %}
  </div>
</div>
